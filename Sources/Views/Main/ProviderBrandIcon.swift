...
enum ProviderBrandAssets {
    static func image(for provider: SubscriptionProvider) -> NSImage? {
        let source: String
        let isTemplate: Bool
        ...
        guard let image = NSImage(data: Data(source.utf8)) else { return nil }
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="1.68 1.75 16.65 16.5" fill="#000000">
